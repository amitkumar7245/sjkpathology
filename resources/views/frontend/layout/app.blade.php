...
<section class="banner-sec-twelve">
    ...
    <img src="{{ asset('frontend/assets/img/icons/section-small-icon-01.svg') }}" class="small-icon-one" alt="Img">
    <img src="{{ asset('frontend/assets/img/icons/section-small-icon-02.svg') }}" class="small-icon-two" alt="Img">
    </div>
    <div class="container">
    ...
    <input type="text" class="form-control" placeholder="Home-12,Gali No.12,Village-Pahi Hardo,Post-Bighapur,Dist.Unnao">
    </div>
    </div>
    </div>
    </div>
    <div class="banner-btns">
    <a href="#" class="btn appoint-btn"><i class="feather-smartphone me-2"></i>Book an Appointment</a>
    </div>     
    </form>
    </div>
    ...
    <span><img src="{{ asset('frontend/assets/img/icons/lab-view-icon.svg') }}" alt="Img"></span>
    ...
    <a href="#"><img src="{{ asset('frontend/assets/img/slider/pregnancy.svg') }}" class="img-fluid" alt="pregnancy"></a>
    </div>
    ...
    <div class="swiper-slide">
    <div class="img-swiper">
    <a href="#"><img src="{{ asset('frontend/assets/img/slider/diabeties-test.svg') }}" class="img-fluid" alt="diabeties-test"></a>
    </div>
    <div class="swiper-content-card">
    ...
    <div class="swiper-slide">
    <div class="img-swiper">
    <a href="#"><img src="{{ asset('frontend/assets/img/slider/liver-test.svg') }}" class="img-fluid" alt="liver-test"></a>
    </div>
    <div class="swiper-content-card">
    ...
    <div class="cat-icon">
    <img src="}{{ asset('frontend/assets/img/icons/all-test.webp') }}">
    </div>
    </div>
    <div class="body-section">
    <h3>All Tests</h3>
    ...
    <span><img src="{{ asset('frontend/assets/img/specialities/specialities-01.svg') }}" alt="heart-image"></span>
    </div>
    <p>Diabeties</p>
    </div>
    </div>
    ...
    <div class="specialities-item">
    <div class="specialities-img">
    <span><img src="{{ asset('frontend/assets/img/specialities/specialities-02.svg') }}" alt="brain-image"></span>
    </div>
    <p>Liver</p>
    </div>
    </div>
    ...
    <div class="specialities-item">
    <div class="specialities-img">
    <span><img src="{{ asset('frontend/assets/img/specialities/specialities-03.svg') }}" alt="kidney-image"></span>
    </div>
    <p>Kidney</p>
    </div>
    </div>
    ...
    <div class="specialities-item">
    <div class="specialities-img">
    <span><img src="{{ asset('frontend/assets/img/specialities/specialities-04.svg') }}" alt="bone-image"></span>
    </div>
    <p>Fever</p>
    </div>
    </div>
    ...
    <div class="specialities-item">
    <div class="specialities-img">
    <span><img src="{{ asset('frontend/assets/img/specialities/specialities-05.svg') }}" alt="dentist"></span>
    </div>
    <p>Thyroid</p>
    </div>
    </div>
    ...
    <div class="specialities-item">
    <div class="specialities-img">
    <span><img src="{{ asset('frontend/assets/img/specialities/specialities-06.svg') }}" alt="eye-image"></span>
    </div>
    <p>Full Body</p>
    </div>
    </div>
    ...
    <img src="{{ asset('frontend/assets/img/bg/slider-bg-img.png') }}" class="img-fluid" alt="Img">
    </div>
    </div>
    <div class="col-md-6">
    ...
    <img src="{{ asset('frontend/assets/img/features/package-card-img-03.png') }}" class="package-img-user" alt="Img">
    <img src="{{ asset('frontend/assets/img/bg/package-card-bg-01.png') }}" class="package-img-bg" alt="Img">
    </div>
    </div>
    ...
    <div class="package-img">
    <img src="{{ asset('frontend/assets/img/features/package-card-img-02.png') }}" class="package-img-user" alt="Img">
    <img src="{{ asset('frontend/assets/img/bg/package-card-bg-03.png') }}" class="package-img-bg" alt="Img">
    </div>
    </div>
    ...
    <div class="package-img">
    <img src="{{ asset('frontend/assets/img/features/package-card-img-01.png') }}" class="package-img-user" alt="Img">
    <img src="{{ asset('frontend/assets/img/bg/package-card-bg-02.png') }}" class="package-img-bg" alt="Img">
    </div>
    </div>
    ...
    <div class="sec-btn">
    <a href="voice-call.html" class="btn btn-primary">Talk With Expert</a>
    </div>
    </div>
    </div>
    </div>
    ...
    <img src="{{ asset('frontend/assets/img/icons/sticker-icon.svg') }}" alt="Img">
    </div>
    <div class="package-icon">
    <img src="{{ asset('frontend/assets/img/icons/package-icon-01.svg') }}" alt="Img">
    </div>
    ...
    <div class="package-card-top">
    <div class="card-img-right">
    <img src="{{ asset('frontend/assets/img/icons/medal-icon.svg') }}" class="medal-icon" alt="Img">
    </div>
    <div class="package-icon">
    <img src="{{ asset('frontend/assets/img/icons/package-icon-02.svg') }}" alt="Img">
    </div>
    ...
    <div class="work-box">
    <div class="work-icon">
    <img src="{{ asset('frontend/assets/img/icons/booking-made-easy.svg') }}" alt="booking-made-easy">
    </div>
    ...
    <div class="work-icon">
    <img src="{{ asset('frontend/assets/img/icons/customer-support.svg') }}" alt="guidance">
    </div>
    <h4>2. Guidance</h4>
    ...
    <p>Enjoy the convenience of free sample collection right at your home or office, conducted seamlessly by our team of seasoned phlebotomists.</p>
    </div>
    </div>
    <div class="col-lg-3 col-md-6 d-flex" data-aos="fade-up" data-aos-delay="800">
    <div class="work-box bg-pink">
    <div class="work-icon">
    <img src="{{ asset('frontend/assets/img/icons/prescriptions.svg') }}" alt="report-download">
    </div>
    <h4>4. Report and Support</h4>
    <p>Experience the industry-first Smart Report, enriched with historical trends and AI-based evaluations. This innovative approach to health reporting comes with complimentary consultations for report discussions.</p>
    </div>
    </div>
    </div>
    </div>
    ...
    <div class="section-bg">
    <img src="{{ asset('frontend/assets/img/icons/book-lab-bg-01.svg') }}" class="best-pack-bg-one" alt="Img">
    <img src="{{ asset('frontend/assets/img/icons/book-lab-bg-02.svg') }}" class="best-pack-bg-two" alt="Img">
    </div>
    <div class="container">
    <div class="row radius-inner">
    <div class="section-head-twelve">
    ...
    <a href="#"><img src="{{ asset('frontend/assets/img/blog/book-lab-01.jpg') }}" class="img-fluid" alt="Img"></a>
    </div>
    ...
    <div class="booking-lab-img">
    <a href="#"><img src="{{ asset('frontend/assets/img/blog/book-lab-02.jpg') }}" class="img-fluid" alt="Img"></a>
    </div>
    <div class="booking-lab-content">
    <ul class="feature-badge">
    ...
    <div class="booking-lab-img">
    <a href="#"><img src="{{ asset('frontend/assets/img/blog/book-lab-03.jpg') }}" class="img-fluid" alt="Img"></a>
    </div>
    <div class="booking-lab-content">
    <ul class="feature-badge">
    <li>Includes 50 Parameters</li>
    ...
    <h6><span><img src="{{ asset('frontend/assets/img/icons/gem.svg') }}" alt="Img"></span>Booked 218 times</h6>
    </div>
    <ul class="feature-badge">
    ...
    <h6><span><img src="{{ asset('frontend/assets/img/icons/gem.svg') }}" alt="Img"></span>Booked 585 times</h6>
    </div>
    <ul class="feature-badge">
    ...
    <h6><span><img src="{{ asset('frontend/assets/img/icons/gem.svg') }}" alt="Img"></span>Booked 358 times</h6>
    </div>
    <ul class="feature-badge">
    <li>Includes 10 tests </li>
    </ul>
    ...
    <h6><span><img src="{{ asset('frontend/assets/img/icons/gem.svg') }}" alt="Img"></span>Booked 268 times</h6>
    </div>
    <ul class="feature-badge">
    <li>Includes 10 tests </li>
    </ul>
    ...
    <div class="choice-head">
    <h4><a href="javascript:void(0);">Vitamin D & B12 Combo</a></h4>
    <h6><span><img src="{{ asset('frontend/assets/img/icons/gem.svg') }}" alt="Img"></span>Booked 485 times</h6>
    </div>
    <ul class="feature-badge">
    ...
    <li class="nav-item" role="presentation">
    <button class="nav-link" id="test-booking-tab" data-bs-toggle="pill" data-bs-target="#test-booking" type="button" role="tab" aria-controls="test-booking" aria-selected="true">Test Booking</button>
    </li>
    <li class="nav-item" role="presentation">
    <button class="nav-link" id="pills-adult-tab" data-bs-toggle="pill" data-bs-target="#pills-adult" type="button" role="tab" aria-controls="pills-adult" aria-selected="false">Adult Care</button>
    </li>
...
<script src="{{ asset('frontend/assets/js/rocket-loader.min.js') }}" data-cf-settings="ffcdb64f2700b2d04c0c39a5-|49" defer></script>
</body>
</html>