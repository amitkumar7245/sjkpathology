                    ...
                    <div class="card-body p-4">
                        <div class="text-center">
                            <div class="profile-user position-relative d-inline-block mx-auto  mb-4">
                                <img src="{{ (!empty($diagnosticData->photo)) ? url('upload/diagnostic_images/'.$diagnosticData->photo) : url('upload/no_image.jpg') }}" class="rounded-circle avatar-xl img-thumbnail user-profile-image" alt="user-profile-image">
                            ...
                            <h5 class="fs-17 mb-1">{{ $diagnosticData->name }}</h5>
                            <p class="text-muted mb-0">Lab Id:- {{ $diagnosticData->reg_number }}</p>
                        </div>
                    </div>
                </div>
                <!--end card-->
                    ...
                    <div class="card-body p-4">
                        <div class="tab-content">
                            <div class="tab-pane active" id="personalDetails" role="tabpanel">
                                <form id="myForm" action="{{ route('diagnostic.profile.store') }}" method="post" enctype="multipart/form-data">
                                    @csrf
                                    <div class="row">
                                        <div class="col-lg-3">
                                            <div class="mb-3">
                                                <label for="firstnameInput" class="form-label">Name</label>
                                                <input type="text" name="name" class="form-control" id="firstnameInput" placeholder="Enter your name" value="{{ $diagnosticData->name }}">
                                            </div>
                                        </div>
                                        <!--end col-->
                                        ...
                                        <div class="col-lg-3">
                                            <div class="mb-3">
                                                ...
                                                <input type="tel" name="phone" class="form-control" id="phonenumberInput" pattern="[0-9]{10}" maxlength="10" placeholder="Enter your mobile number" value="{{ $diagnosticData->phone }}">
                                            </div>
                                        </div>
                                        <!--end col-->
                                        <div class="col-lg-3">
                                            <div class="mb-3">
                                                ...
                                                <input type="email" name="email" class="form-control" id="emailInput" placeholder="Enter your email" value="{{ $diagnosticData->email }}">
                                            </div>
                                        </div>
                                        <!--end col-->
                                        <div class="col-lg-3">
                                            <div class="mb-3">
                                                ...
                                                <input type="date" name="doj" class="form-control" data-provider="flatpickr" id="JoiningDate" value="{{ $diagnosticData->doj }}">
                                        ...
                                        <div class="col-lg-3">
                                            <div class="mb-3">
                                                ...
                                                <input type="tel" name="aadharcard" class="form-control" id="aadharcard" minlength="12" maxlength="12" placeholder="0000 0000 0000" value="{{ $diagnosticData->aadharnumber }}">
                                            </div>
                                        </div>
                                        <!--end col-->
                                        <div class="col-lg-3">
                                        ...
                                        <div class="col-lg-3">
                                            <div class="mb-3">
                                                ...
                                                <img id="showImage" src="{{ (!empty($diagnosticData->photo)) ? url('upload/diagnostic_images/'.$diagnosticData->photo) : url('upload/no_image.jpg') }}" alt="image" style="width:100px; height:100px;">
                                        ...
                                        <div class="col-lg-12">
                                            <div class="mb-3 pb-2">
                                                ...
                                                <textarea class="form-control" name="address" id="inputAddress3" placeholder="Enter Address" rows="3">{{ $diagnosticData->address }}</textarea>
                                            </div>
                                        </div>
                                        <!--end col-->
