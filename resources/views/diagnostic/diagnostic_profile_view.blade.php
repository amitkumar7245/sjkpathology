                    ...
                    <div class="card-body p-4">
                        <div class="text-center">
                            <div class="profile-user position-relative d-inline-block mx-auto  mb-4">
                                <img src="{{ (!empty($diagnosticData->photo)) ? url($diagnosticData->photo) : url('upload/no_image.jpg') }}" class="rounded-circle avatar-xl img-thumbnail user-profile-image" alt="user-profile-image">
                    ...
                    <div class="card-body p-4">
                        <div class="tab-content">
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-lg-3">
                                            <div class="mb-3 form-groups">
                                                ...
                                                <input type="tel" name="phone" class="form-control" id="phonenumberInput" maxlength="10" placeholder="Enter your phone number" value="{{ $diagnosticData->phone }}" oninput="this.value = this.value.replace(/[^0-9.]/g, '').replace(/(\..*?)\..*/g, '$1');">
                                        ...
                                        <div class="col-lg-3">
                                            <div class="mb-3 form-groups">
                                                <label for="emailInput" class="form-label label-required">Email Address</label>
                                        ...
                                        <div class="col-lg-3">
                                            <div class="mb-3">
                                                ...
                                                <img id="showImage" src="{{ (!empty($diagnosticData->photo)) ? url($diagnosticData->photo) : url('upload/no_image.jpg') }}" alt="image" style="width:100px; height:100px;">
                            ...
                            <div class="tab-pane" id="locationDetails" role="tabpanel">
                                <form id="myForm" action="{{ route('diagnostic.location.store') }}" method="post">
                                   @csrf
                                    <div class="row">
                                        <div class="col-lg-3">
                                        ...
                                        <div class="col-lg-3">
                                            <div class="mb-3 form-groups">
                                                ...
                                                <input type="text" class="form-control" name="locationname" id="nameInput" placeholder="Enter Location" value="{{ $diagnosticData->diagnostic->locationname }}">
                                            </div>
                                        </div>
                                        <!--end col-->
...
<script type="text/javascript">
    ...
    $(document).ready(function(){
        $('select[name="country_id"]').on('change', function(){
            ...
            if (country_id) {
                $.ajax({
                    url: "{{ url('/diagnosticprofilestate/ajax') }}/"+country_id,
                    type: "GET",
                    dataType:"json",
...
<script type="text/javascript">
    ...
    $(document).ready(function(){
        $('select[name="state_id"]').on('change', function(){
            ...
            if (state_id) {
                $.ajax({
                    url: "{{ url('/diagnosticprofilecity/ajax') }}/"+state_id,
                    type: "GET",
                    dataType:"json",
                    success:function(data){
...
<script type="text/javascript">
    $(document).ready(function (){
        ...
        $.ajax({
            type: "POST",
            url: "{{ route('diagnosticcheck.phone') }}", // Change this to the route that checks the phone number
            data: {
                phone: value,
