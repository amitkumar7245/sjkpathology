                    ...
                    <div class="card-body p-4">
                        <div class="text-center">
                            <div class="profile-user position-relative d-inline-block mx-auto  mb-4">
                                <img src="{{ (!empty($collectionData->photo)) ? url('upload/collection_images/'.$collectionData->photo) : url('upload/no_image.jpg') }}" class="rounded-circle avatar-xl img-thumbnail user-profile-image" alt="user-profile-image">
                            ...
                            <h5 class="fs-17 mb-1">{{ $collectionData->name }}</h5>
                            <p class="text-muted mb-0">Lab Id:- {{ $collectionData->reg_number }}</p>
                        </div>
                    </div>
                </div>
                <!--end card-->
                    ...
                    <div class="card-body p-4">
                        <div class="tab-content">
                            <div class="tab-pane active" id="personalDetails" role="tabpanel">
                                <form id="myForm" action="{{ route('collection.profile.store') }}" method="post" enctype="multipart/form-data">
                                    @csrf
                                    <div class="row">
                                        <div class="col-lg-3">
                                            <div class="mb-3">
                                                <label for="firstnameInput" class="form-label">Name</label>
                                                <input type="text" name="name" class="form-control" id="firstnameInput" placeholder="Enter your name" value="{{ $collectionData->name }}">
                                            </div>
                                        </div>
                                        <!--end col-->
                                        ...
                                        <div class="col-lg-3">
                                            <div class="mb-3">
                                                ...
                                                <input type="tel" name="phone" class="form-control" id="phonenumberInput" pattern="[0-9]{10}" maxlength="10" placeholder="Enter your mobile number" value="{{ $collectionData->phone }}">
                                            </div>
                                        </div>
                                        <!--end col-->
                                        <div class="col-lg-3">
                                            <div class="mb-3">
                                                <label for="emailInput" class="form-label">Email
                                                    Address</label>
                                                <input type="email" name="email" class="form-control" id="emailInput" placeholder="Enter your email" value="{{ $collectionData->email }}">
                                            </div>
                                        </div>
                                        <!--end col-->
                                        ...
                                        <div class="col-lg-3">
                                            <div class="mb-3">
                                                ...
                                                <input type="date" name="doj" class="form-control" data-provider="flatpickr" id="JoiningDate" value="{{ $collectionData->doj }}">
                                        ...
                                        <div class="col-lg-3">
                                            <div class="mb-3">
                                                ...
                                                <input type="tel" name="aadharcard" class="form-control" id="aadharcard" minlength="12" maxlength="12" placeholder="0000 0000 0000" value="{{ $collectionData->aadharnumber }}">
                                            </div>
                                        </div>
                                        <!--end col-->
                                        <div class="col-lg-3">
                                        ...
                                        <div class="col-lg-3">
                                            <div class="mb-3">
                                                ...
                                                <img id="showImage" src="{{ (!empty($collectionData->photo)) ? url('upload/collection_images/'.$collectionData->photo) : url('upload/no_image.jpg') }}" alt="image" style="width:100px; height:100px;">
                                        ...
                                        <div class="col-lg-12">
                                            <div class="mb-3 pb-2">
                                                ...
                                                <textarea class="form-control" name="address" id="inputAddress3" placeholder="Enter Address" rows="3">{{ $collectionData->address }}</textarea>
                                            </div>
                                        </div>
                                        <!--end col-->
                                    ...
                                    <div class="row">
                                        <div class="col-lg-3">
                                            ...
                                            <select class="js-example-basic-single mb-3" name="country_id">
                                                ...
                                                <option value="{{ $item->id }}" {{ $item->id == $diagnosticData->diagnostic->country_id ? 'selected' : '' }}>{{ $item->country_name }}</option>
                                            @endforeach --}}
                                        ...
                                        <div class="col-lg-3">
                                            ...
                                            <select class="js-example-basic-single mb-3" name="state_id">
                                                ...
                                                <option value="{{ $item->id }}" {{ $item->id == $diagnosticData->diagnostic->state_id ? 'selected' : '' }}>{{ $item->state_name }}</option>
                                            @endforeach --}}
                                            </select>
                                        </div>
                                        <!--end col-->
                                        <div class="col-lg-3">
                                            ...
                                            <select class="js-example-basic-single mb-3" name="city_id">
                                                ...
                                                <option value="{{ $item->id }}" {{ $item->id == $diagnosticData->diagnostic->city_id ? 'selected' : '' }}>{{ $item->city_name }}</option>
                                            @endforeach --}}
                                            </select>
                                        </div>
                                        <!--end col-->
                            ...
                            {{-- <div class="tab-pane" id="clinicdetails" role="tabpanel">
                                <form action="javascript:void(0);">
                                    <div class="row">
                                        <div class="col-lg-6">
                                            <div class="mb-3">
                                                <label for="firstnameInput" class="form-label">Clinic Name</label>
                                                <input type="text" name="clinicname" class="form-control" id="firstnameInput" placeholder="Enter your Clinic Name" value="">
                                            </div>
                                        </div>
                                        <!--end col-->
                                        <div class="col-lg-6">
                                            <div class="mb-3">
                                                ...
                                                <input type="text" name="gstnumber" class="form-control" id="phonenumberInput" placeholder="Enter GST number" value="">
                                            </div>
                                        </div>
                                        <!--end col-->
                                        <div class="col-lg-6">
                                            <div class="mb-3">
                                                ...
                                                <input type="text" name="phone" class="form-control" id="phonenumberInput" placeholder="Enter your phone number" value="">
                                            </div>
                                        </div>
                                        <!--end col-->
                                        <div class="col-lg-6">
                                        ...
                                        <div class="col-lg-12">
                                            <div>
                                                <label for="exampleFormControlTextarea5" class="form-label" data-sider-select-id="def7e3fd-871e-4110-843d-f17799cf3859">Clinic Address</label>
                                                <textarea class="form-control" id="exampleFormControlTextarea5" rows="2" data-sider-insert-id="db56a32b-06aa-4ce5-953d-f424be402e5f" data-sider-select-id="88d465a9-db80-4e2b-bff6-d67cdb19dabd"></textarea>
                                            </div>
                                        </div>
                                        <!--end col-->
...
<script type="text/javascript">
    $(document).ready(function (){
        $('#myForm').validate({
            ...
            messages :{
                socialtype_name: {
                    required : 'Please Enter Social Media Type Name',
                },
            },
            errorElement : 'span', 
