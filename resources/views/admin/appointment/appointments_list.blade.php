                ...
                <div class="card">
                    ...
                    <div class="card-body">
                        <table id="buttons-datatables" class="table table-bordered table-hover dt-responsive nowrap align-middle mdl-data-table dataTable no-footer" style="width:100%">
                            ...
                            <tbody>
                                @foreach ($bookappointmentView as $key => $item )
                                    <tr>
                                        <th scope="row">
                                            <div class="form-check">
                                        ...
                                        <td class="status"><span class="badge bg-danger-subtle text-danger text-uppercase">Pending</span></td>
                                        @else
                                        <td class="status"><span class="badge bg-success-subtle text-success text-uppercase">Done</span></td> 
                                        @endif 
                                        <td>
                                            ...
                                            @if ($item->status == 'pending')
                                                <a href="{{ route('pending.bookappointments', $item->id) }}" class="btn btn-danger btn-sm" title="Pending"> <i class="fa-solid fa-thumbs-down"></i></a>
                                            @else
                                                <a href="{{ route('done.bookappointments', $item->id) }}" class="btn btn-primary btn-sm" title="Done"> <i class="fa-solid fa-thumbs-up"></i></a>
                                            @endif
                                        </td>
