            ...
            <div class="row">
                <div class="col-12">
                    <div class="page-title-box d-sm-flex align-items-center justify-content-between">
                        <h4 class="mb-sm-0">Create Diagnostic Centres</h4>

                        <div class="page-title-right">
                            <ol class="breadcrumb m-0">
                                <li class="breadcrumb-item"><a href="javascript: void(0);">Home</a></li>
                                <li class="breadcrumb-item active">Create Diagnostic Centres</li>
                            </ol>
                        </div>
                ...
                <div class="col-lg-12">
                    <div class="card border-top border-0 border-4 border-primary">
                        <div class="card-body p-4">
                            <form id="myForm" action="{{ route('store.diagnosticcenter') }}" method="post"
                                ...
                                <div class="tshadow mb25 bozero">
                                    ...
                                    <div class="around10">
                                        <div class="row">
                                            ...
                                            <div class="col-lg-3">
                                                <div class="mb-3 form-groups">
                                                    <label for="phonenumberInput" class="form-label label-required">Mobile
                                                        Number</label>
                                                    <input type="tel" name="phone" class="form-control"
                                                        id="phonenumberInput" maxlength="10"
                                            ...
                                            <div class="col-lg-3">
                                                <div class="mb-3 form-groups">
                                                    <label for="JoiningDate" class="form-label label-required">Joining
                                                        Date</label>
                                            ...
                                            <div class="col-lg-3">
                                                <div class="mb-3 form-groups">
                                                    <label for="passwordInput"
                                                        class="form-label label-required">Password</label>
                                                    <input type="password" name="password" class="form-control"
                                                        id="passwordInput" placeholder="Enter your password" value="">
                                                </div>
                                            </div>
                                            <!--end col-->
                                        </div>
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-lg-3">
                                                <div class="mb-3 form-groups">
                                                    <label for="locationInput"
                                                        class="form-label label-required">Location</label>
                                            ...
                                            <div class="col-lg-12">
                                                <label for="inputAddress3"
                                                    class="form-label label-required">Address</label>
                                ...
                                <div class="tshadow mb25 bozero">
                                    ...
                                    <div class="around10">
                                        <div class="row">
                                            ...
                                            <div class="col-md-6 mb-3">
                                                <div class="input-group mb-3">
                                                    <label class="input-group-text" for="inputGroupFile01">Aadhar
                                                        Card</label>
