                ...
                <div class="col-lg-12">
                    <div class="card border-top border-0 border-4 border-primary">
                        <div class="card-body p-4">
                            <form id="myForm" action="{{ route('store.diagnosticcenter') }}" method="post" enctype="multipart/form-data">
                                            ...
                                            {{-- <div class="col-lg-4 col-md-6">
                                                <div>
                                                    <div class="form-check mb-2">
                                                        <input class="form-check-input" type="radio" name="diagnostic_name" id="labCenter" checked="">
                                                        <label class="form-check-label" for="labCenter">
                                                            Is a Diagnostic Center
                                                        </label>
                                                    </div>
                                                    <div class="form-check">
                                                        <input class="form-check-input" type="radio" name="collection_name" id="collectionCenter">
                                                        <label class="form-check-label" for="collectionCenter">
                                                            Is a Collection Center
                                                        </label>
                                                    </div>
                                                </div>
                                            </div>
                                    ...
                                    <div class="around10">
                                        <div class="row">
                                            <div class="col-lg-4 col-md-6">
                                                <div>
                                                    <div class="form-check mb-2">
                                                        <input class="form-check-input" name="collectioncenter1" type="checkbox" id="formCheck1">
