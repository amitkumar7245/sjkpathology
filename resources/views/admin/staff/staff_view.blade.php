    ...
    <div class="container-fluid">
        ...
        <div class="pt-4 mb-4 mb-lg-3 pb-lg-4 profile-wrapper">
            <div class="row g-4">
                ...
                <div class="col">
                    <div class="p-2">
                        <h3 class="text-white mb-1">{{ $staff_view->name ?? 'N/A' }}</h3>
                        <p class="text-white text-opacity-75">Reg.ID:- {{ $staff_view->reg_number ?? 'N/A' }}</p>
                        <div class="hstack text-white-50 gap-1">
                            <div class="me-2"><i class="ri-map-pin-user-line me-1 text-white text-opacity-75 fs-16 align-middle"></i>{{ $staff_view->address ?? 'N/A' }} </div>
                ...
                <div>
                    <div class="d-flex profile-wrapper">
                        ...
                        <div class="flex-shrink-0">
                            <a href="{{ route('edit.staff', $staff_view->id) }}" class="btn btn-success"><i class="ri-edit-box-line align-bottom"></i> Edit Profile</a>
                        </div>
                    </div>
                    <!-- Tab panes -->
                                                ...
                                                <table class="table table-borderless mb-0">
                                                    <tbody>
                                                        ...
                                                        <tr>
                                                            ...
                                                            <td class="text-muted">{{ $staff_view->phone ?? 'N/A' }}</td>
                                                        </tr>
                                                        <tr>
                                                            <th class="ps-0" scope="row">E-mail :</th>
                                                            <td class="text-muted">{{ $staff_view->email ?? 'N/A' }}</td>
                                                        </tr>
                                                        <tr>
                                                            <th class="ps-0" scope="row">Gender</th>
                                                            <td class="text-muted">
                                                                {{ $staff_view->gender == 1 ? 'Male' : ($staff_view->gender == 0 ? 'Female' : 'Not specified') }}
                                                            </td>
                                                        </tr>
                                                        <tr>
                                                            <th class="ps-0" scope="row">Location :</th>
                                                            <td class="text-muted">{{ $staff_view->staff->locationname ?? 'N/A' }}
                                                            </td>
                                                        </tr>
                                                        <tr>
                                                            <th class="ps-0" scope="row">Joining Date</th>
                                                            <td class="text-muted">{{ $staff_view->dob ?? 'N/A' }}</td>
                                                        </tr>
                                                        
                                                        <tr>
                                                            <th class="ps-0" scope="row">Date of Birthday</th>
                                                            <td class="text-muted">{{ $staff_view->doj ?? 'N/A' }}</td>
                                                        </tr>
                                                        <tr>
                                                        ...
                                                        <tr>
                                                            <th class="ps-0" scope="row">Department Name</th>
                                                            <td class="text-muted">{{ $staff_view->staff->department->department_name ?? 'N/A' }}</td>
                                                        </tr>
                                                        <tr>
                                                            <th class="ps-0" scope="row">Designation Name</th>
                                                            <td class="text-muted">{{ $staff_view->staff->designation->designation_name ?? 'N/A' }}</td>
                                                        </tr>
                                                    </tbody>
                                                </table>
                                            </div>
                                                ...
                                                <table class="table table-borderless mb-0">
                                                    <tbody>
                                                        <tr>
                                                            ...
                                                            <td class="text-muted">{{ $staff_view->staff->country->country_name ?? 'N/A' }}</td>
                                                        </tr>
                                                        <tr>
                                                            <th class="ps-0" scope="row">State :</th>
                                                            <td class="text-muted">{{ $staff_view->staff->state->state_name ?? 'N/A' }}</td>
                                                        </tr>
                                                        <tr>
                                                            <th class="ps-0" scope="row">City :</th>
                                                            <td class="text-muted">{{ $staff_view->staff->city->city_name ?? 'N/A' }}</td>
                                                        </tr>
                                                        <tr>
                                                            <th class="ps-0" scope="row">Location :</th>
                                                            <td class="text-muted">{{ $staff_view->staff->locationname ?? 'N/A' }}</td>
                                                        </tr>
                                                ...
                                                <table class="table table-borderless mb-0">
                                                    <tbody>
                                                        <tr>
                                                            ...
                                                            <td class="text-muted">{{ $staff_view->staff->bank->bankname ?? 'N/A' }}</td>
                                                        </tr>
                                                        <tr>
                                                            <th class="ps-0" scope="row">Branch Name :</th>
                                                            <td class="text-muted">{{ $staff_view->staff->branchname ?? 'N/A' }}</td>
                                                        </tr>
                                                        <tr>
                                                            <th class="ps-0" scope="row">IFSC Code :</th>
                                                            <td class="text-muted">{{ $staff_view->staff->ifsccode ?? 'N/A' }}</td>
                                                        </tr>
                                                        <tr>
                                                            <th class="ps-0" scope="row">Account Number :</th>
                                                            <td class="text-muted">{{ $staff_view->staff->accountnumber ?? 'N/A' }}</td>
                                                        </tr>
                                                        <tr>
                                                            <th class="ps-0" scope="row">Account Holder Name :</th>
                                                            <td class="text-muted">{{ $staff_view->staff->accountholdername ?? 'N/A' }}</td>
                                                        </tr>
                                                        <tr>
                                                            <th class="ps-0" scope="row">Salary :</th>
                                                            <td class="text-muted">{{ $staff_view->staff->salary ?? 'N/A' }}</td>
                                                        </tr>
                                                    </tbody>
                                                </table>
                                            </div>
