                ...
                <div class="col-lg-12">
                    <div class="card border-top border-0 border-4 border-primary">
                        <div class="card-body p-4">
                            <form id="myForm" action="{{ route('store.staff') }}" method="post" enctype="multipart/form-data">
                                @csrf
                                                ...
                                                <select class="js-example-basic-single mb-3 form-groups" name="employeetype_id">
                                                    <option>Select Employee Type </option>
                                                        @foreach ($emptype as $item )
                                                            <option value="{{ $item->id }}">{{ $item->employee_type_name }}</option>
                                                        @endforeach
                                                </select>
                                            </div>
                                            <!--end col-->
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-lg-3">
                                                <div class="mb-3">
                                                    ...
                                                    <input type="text" name="salary" class="form-control" id="salaryInput" placeholder="10,000/" value="">
                                                </div>
                                            </div>
                                            <!--end col-->
                                            <div class="col-lg-3">
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-md-6 mb-3">
                                                <div class="input-group mb-3">
                                                    ...
                                                    <input type="file" name="aadharphoto" class="form-control" id="inputGroupFile02">
                                                </div>
                                            </div>
                                            <!--end col-->
