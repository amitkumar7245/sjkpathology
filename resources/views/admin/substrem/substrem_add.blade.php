        ...
        <div class="row">
            <div class="col-12">
                <div class="page-title-box d-sm-flex align-items-center justify-content-between">
                    <h4 class="mb-sm-0">Create Substrem</h4>

                    <div class="page-title-right">
                        <ol class="breadcrumb m-0">
                            <li class="breadcrumb-item"><a href="javascript: void(0);">Home</a></li>
                            <li class="breadcrumb-item active">Create Substrem</li>
                        </ol>
                    </div>
                ...
                <div class="col-lg-12">
                    <div class="card border-top border-0 border-4 border-primary">
                        <div class="card-body p-4">
                            <form id="myForm" action="{{ route('store.substrem') }}" method="post">
                                @csrf
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-lg-6">
                                                <div class="mb-3 form-groups">
                                                    ...
                                                    <input type="text" name="substrem_name" class="form-control" id="substremnameInput" placeholder="Enter your substrem Name">
                                                </div>
                                            </div>
                                            <!--end col-->
                                        </div>
