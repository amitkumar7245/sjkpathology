        ...
        <div class="row">
            <div class="col-12">
                <div class="page-title-box d-sm-flex align-items-center justify-content-between">
                    <h4 class="mb-sm-0">Create Test Blood Group</h4>

                    <div class="page-title-right">
                        <ol class="breadcrumb m-0">
                            <li class="breadcrumb-item"><a href="javascript: void(0);">Home</a></li>
                            <li class="breadcrumb-item active">Create Test Blood Group</li>
                        </ol>
                    </div>
                ...
                <div class="col-lg-12">
                    <div class="card border-top border-0 border-4 border-primary">
                        <div class="card-body p-4">
                            <form id="myForm" action="{{ route('store.testbloodgroup') }}" method="post">
                                @csrf
                                        ...
                                        <div class="row">
                                                ...
                                                <select class="js-example-basic-single mb-3 form-groups" name="testblood_id">
                                                    <option>Select Test Blood </option>
                                                        @foreach ($testBlood as $item )
                                                            <option value="{{ $item->id }}">{{ $item->testblood_name }}</option>
                                                        @endforeach
                                                </select>
                                            </div>
                                            <!--end col-->
                                            <div class="col-lg-4">
                                                <div class="mb-3 form-groups">
                                                    ...
                                                    <input type="text" name="testbloodgroup_name" class="form-control" id="testbloodgroupnameInput" placeholder="Enter your Test Blood Group Name">
                                                </div>
                                            </div>
                                            <!--end col-->
                                            ...
                                            <div class="col-lg-4">
                                                <div class="mb-3 form-groups">
                                                    ...
                                                    <input type="text" name="testbloodgroup_code" class="form-control" id="testbloodgroupnameInput" placeholder="Enter your Short Cut Name">
                                                </div>
                                            </div>
                                            <!--end col-->
                                                ...
                                                <select class="js-example-basic-single mb-3 form-groups" name="sampletype_id">
                                                    <option>Select Sample Type </option>
                                                        @foreach ($testsampletype as $item )
                                                            <option value="{{ $item->id }}">{{ $item->sampletype_name }}</option>
                                                        @endforeach
                                                </select>
                                            </div>
                                            <!--end col-->
                                            <div class="col-lg-4">
                                                ...
                                                <div class="input-group mb-3">
                                                    <input type="text" name="testbloodgroup_price" class="form-control" id="testbloodgrouppriceInput" placeholder="Enter price" aria-label="Price" aria-describedby="basic-addon2">
                                            ...
                                            <div class="col-lg-12">
                                                ...
                                                <textarea name="testbloodgroup_precautions" class="form-control" id="precautioninput" placeholder="Enter Precaution" rows="3"></textarea>
                                            </div>
                                            <!--end col-->
