                                    ...
                                    <div class="around10">
                                        <div class="row">
                                            <div class="col-lg-4">
                                                ...
                                                <select class="js-example-basic-single mb-3 form-groups"
                                                    ...
                                                    @foreach ($testBlood as $item)
                                                        <option value="{{ $item->id }}">{{ $item->testblood_name }}
                                                        </option>
                                                    @endforeach
                                                </select>
                                            </div>
                                            ...
                                            <div class="col-lg-4">
                                                <div class="mb-3 form-groups">
                                                    ...
                                                    <input type="text" name="testbloodgroup_name" class="form-control"
                                                        ...
                                                        placeholder="Enter your Test Blood Group Name">
                                                </div>
                                            </div>
                                            <!--end col-->
                                            ...
                                            <div class="col-lg-4">
                                                <div class="mb-3 form-groups">
                                                    ...
                                                    <input type="text" name="testbloodgroup_code" class="form-control"
                                                        id="testbloodgroupnameInput"
                                                        placeholder="Enter your Short Cut Name">
                                                </div>
                                            </div>
                                            <!--end col-->
                                            ...
                                            <div class="col-lg-4">
                                                ...
                                                <select class="js-example-basic-single mb-3 form-groups"
                                                    ...
                                                    @foreach ($testsampletype as $item)
                                                        <option value="{{ $item->id }}">{{ $item->sampletype_name }}
                                                        </option>
                                                    @endforeach
                                                </select>
                                            </div>
                                            ...
                                            <div class="col-lg-12">
                                                ...
                                                <textarea name="testbloodgroup_precautions" class="form-control" id="precautioninput" placeholder="Enter Precaution"
                                                    rows="3"></textarea>
                                            </div>
                                            <!--end col-->
