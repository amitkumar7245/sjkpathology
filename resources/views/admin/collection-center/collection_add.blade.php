        ...
        <div class="row">
            <div class="col-12">
                <div class="page-title-box d-sm-flex align-items-center justify-content-between">
                    <h4 class="mb-sm-0">Create Collection Centres</h4>

                    <div class="page-title-right">
                        <ol class="breadcrumb m-0">
                            <li class="breadcrumb-item"><a href="javascript: void(0);">Home</a></li>
                            <li class="breadcrumb-item active">Create Collection Centres</li>
                        </ol>
                    </div>
                ...
                <div class="col-lg-12">
                    <div class="card border-top border-0 border-4 border-primary">
                        <div class="card-body p-4">
                            <form id="myForm" action="{{ route('store.collectioncenter') }}" method="post" enctype="multipart/form-data">
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-lg-3">
                                                <div class="mb-3 form-groups">
                                                    ...
                                                    <input type="text" name="aadharcard" class="form-control" id="aadharcardInput" minlength="12" maxlength="12" placeholder="0000 0000 0000" value="">
                                                </div>
                                            </div>
                                            <!--end col-->
                                        ...
                                        <div class="row">
                                            <div class="col-md-6 mb-3">
                                                <div class="input-group mb-3">
                                                    <label class="input-group-text" for="inputGroupFile1">Image</label>
                                                    <input type="file" name="collectionimage" class="form-control" id="inputGroupFile1" accept=".jpg,.png,.jpeg">
                                                </div>
                                            </div>
                                            <!--end col-->
                                            <div class="col-md-6 mb-3">
