    ...
    <div class="container-fluid">
        ...
        <div class="pt-4 mb-4 mb-lg-3 pb-lg-4 profile-wrapper">
            <div class="row g-4">
                <div class="col-auto">
                    <div class="avatar-lg">
                        @if ($collection_view->photo != '')
                            <img src="{{ asset('upload/collection_images/'.$collection_view->photo) }}" alt="" class="img-thumbnail rounded-circle">
                        @else
                ...
                <div class="col">
                    <div class="p-2">
                        <h3 class="text-white mb-1">{{ $collection_view->name ?? 'N/A' }}</h3>
                        <p class="text-white text-opacity-75">Reg.ID:- {{ $collection_view->reg_number ?? 'N/A' }}</p>
                        <div class="hstack text-white-50 gap-1">
                            <div class="me-2"><i class="ri-map-pin-user-line me-1 text-white text-opacity-75 fs-16 align-middle"></i>{{ $collection_view->address ?? 'N/A' }} </div>
                ...
                <div>
                    <div class="d-flex profile-wrapper">
                        ...
                        <div class="flex-shrink-0">
                            <a href="{{ route('edit.collectioncenter', $collection_view->id) }}" class="btn btn-success"><i class="ri-edit-box-line align-bottom"></i> Edit Profile</a>
                        </div>
                    </div>
                    <!-- Tab panes -->
                                                ...
                                                <table class="table table-borderless mb-0">
                                                    <tbody>
                                                        ...
                                                        <tr>
                                                            ...
                                                            <td class="text-muted">{{ $collection_view->phone ?? 'N/A' }}</td>
                                                        </tr>
                                                        <tr>
                                                            <th class="ps-0" scope="row">E-mail :</th>
                                                            <td class="text-muted">{{ $collection_view->email ?? 'N/A' }}</td>
                                                        </tr>
                                                        
                                                        <tr>
                                                            <th class="ps-0" scope="row">Location :</th>
                                                            <td class="text-muted">{{ $collection_view->collection->locationname ?? 'N/A' }}
                                                            </td>
                                                        </tr>
                                                        
                                                        <tr>
                                                            <th class="ps-0" scope="row">Joining Date</th>
                                                            <td class="text-muted">{{ $collection_view->doj ?? 'N/A' }}</td>
                                                        </tr>
                                                        <tr>
                                                ...
                                                <table class="table table-borderless mb-0">
                                                    <tbody>
                                                        ...
                                                        <tr>
                                                            ...
                                                            <td class="text-muted">{{ $collection_view->collection->state->state_name ?? 'N/A' }}</td>
                                                        </tr>
                                                        <tr>
                                                            <th class="ps-0" scope="row">City :</th>
                                                            <td class="text-muted">{{ $collection_view->collection->city->city_name ?? 'N/A' }}</td>
                                                        </tr>
                                                        <tr>
                                                            <th class="ps-0" scope="row">Location :</th>
