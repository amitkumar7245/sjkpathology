                ...
                <div class="col-lg-12">
                    <div class="card border-top border-0 border-4 border-primary">
                        <div class="card-body p-4">
                            <form id="myForm" action="{{ route('store.testsampletype') }}" method="post">
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-lg-4">
                                                <div class="mb-3 form-groups">
                                                    ...
                                                    <input type="text" name="sampletype_name" class="form-control" id="testsampletypenameInput" placeholder="Enter your Test Sample Type Name">
                                                </div>
                                            </div>
                                            <!--end col-->
