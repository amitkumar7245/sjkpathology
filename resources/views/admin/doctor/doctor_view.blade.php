                                                ...
                                                <table class="table table-borderless mb-0">
                                                    <tbody>
                                                        ...
                                                        <tr>
                                                            ...
                                                            <td class="text-muted">{{ $doctor_view->aadharnumber }}</td>
                                                        </tr>
                                                ...
                                                <table class="table table-borderless mb-0">
                                                    <tbody>
                                                        ...
                                                        <tr>
                                                            ...
                                                            <td class="text-muted">{{ $doctor_view->doctor->country->country_name ?? 'N/A' }}</td>
                                                        </tr>
                                                        <tr>
                                    ...
                                    <div class="card">
                                        <div class="card-body">
                                            ...
                                            <div class="table-responsive">
                                                <table class="table table-borderless mb-0">
                                                    <tbody>
                                                        @if($doctor_view->clinic)
                                                            <tr>
                                                                <th class="ps-0" scope="row">Clinic Name:</th>
                                                                <td class="text-muted">{{ $doctor_view->clinic->clinic_name ?? 'N/A' }}</td>
                                                            </tr>
                                                            <tr>
                                                                <th class="ps-0" scope="row">Clinic Owner Name :</th>
                                                                <td class="text-muted">{{ $doctor_view->clinic->clinicowner_name ?? 'N/A' }}</td>
                                                            </tr>
                                                            <tr>
                                                                <th class="ps-0" scope="row">Clinic GST Number :</th>
                                                                <td class="text-muted">{{ $doctor_view->clinic->gst_number ?? 'N/A' }}</td>
                                                            </tr>
                                                            <tr>
                                                                <th class="ps-0" scope="row">Clinic Phone Number :</th>
                                                                <td class="text-muted">{{ $doctor_view->clinic->phone_number ?? 'N/A' }}</td>
                                                            </tr>
                                                            <tr>
                                                                <th class="ps-0" scope="row">Clinic Telephone Number :</th>
                                                                <td class="text-muted">{{ $doctor_view->clinic->telephonephone_number ?? 'N/A' }}</td>
                                                            </tr>
                                                            <tr>
                                                                <th class="ps-0" scope="row">Clinic Email :</th>
                                                                <td class="text-muted">{{ $doctor_view->clinic->clinic_email ?? 'N/A' }}</td>
                                                            </tr>
                                                            <tr>
                                                                <th class="ps-0" scope="row">State :</th>
                                                                <td class="text-muted">{{ $doctor_view->clinic->state->state_name ?? 'N/A' }}</td>
                                                            </tr>
                                                            <tr>
                                                                <th class="ps-0" scope="row">City :</th>
                                                                <td class="text-muted">{{ $doctor_view->clinic->city->city_name ?? 'N/A' }}</td>
                                                            </tr>
                                                            <tr>
                                                                <th class="ps-0" scope="row">Clinic Address :</th>
                                                                <td class="text-muted">{{ $doctor_view->clinic->clinic_address ?? 'N/A' }}</td>
                                                            </tr>
                                                        @else
                                                            <tr>
                                                ...
                                                <table class="table table-borderless mb-0">
                                                    <tbody>
                                                        <tr>
                                                            ...
                                                            <td class="text-muted">{{ $doctor_view->doctor->bank->bankname ?? 'N/A' }}</td>
                                                        </tr>
                                                        <tr>
                                                            <th class="ps-0" scope="row">Branch Name :</th>
                                                            <td class="text-muted">{{ $doctor_view->doctor->branchname ?? 'N/A' }}</td>
                                                        </tr>
                                                        <tr>
                                                            <th class="ps-0" scope="row">IFSC Code :</th>
                                                            <td class="text-muted">{{ $doctor_view->doctor->ifsccode ?? 'N/A' }}</td>
                                                        </tr>
                                                        <tr>
                                                            <th class="ps-0" scope="row">Account Number :</th>
                                                            <td class="text-muted">{{ $doctor_view->doctor->accountnumber ?? 'N/A' }}</td>
                                                        </tr>
                                                        <tr>
                                                            <th class="ps-0" scope="row">Account Holder Name :</th>
                                                            <td class="text-muted">{{ $doctor_view->doctor->accountholdername ?? 'N/A' }}</td>
                                                        </tr>
                                                        <tr>
                                                            <th class="ps-0" scope="row">Commission :</th>
                                                            <td class="text-muted">{{ $doctor_view->doctor->commission ?? 'N/A' }}%</td>
                                                        </tr>
                                                    </tbody>
                                                </table>
                                            </div>
