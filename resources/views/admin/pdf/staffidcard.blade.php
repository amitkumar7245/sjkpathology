...
<body>
    <div class="card">
        <div class="card-header">
            <img src="upload/sjk_logo/sjk-logo.png" alt="pathology-logo" style="height:58px;">
        </div>
        <div class="card-content" id="ICARD">
            <img src="upload/staff_images/{{ $staffPrintIdcard->photo }}" alt="staff-image" width="55px" height="90px">
            <table>
                <tr>
        ...
        <div class="card-footer">
            <img src="upload/sjk_logo/qr.jpg" alt="Barcode Footer" style="width: 120px; height: 40px; float: left; border: 1px solid #57b3e9;">
