    ...
    <div class="container-fluid">
        ...
        <div class="pt-4 mb-4 mb-lg-3 pb-lg-4 profile-wrapper">
            <div class="row g-4">
                <div class="col-auto">
                    <div class="avatar-lg">
                        @if ($doctors_view->photo != '')
                            <img src="{{ asset($doctors_view->photo) }}" alt="" class="img-thumbnail rounded-circle">
                        @else
                            @if ($doctors_view->gender == '1') <!-- Assuming '1' for Male -->
                                <img src="{{ asset('backend/assets/images/users/male-dummy.png') }}" alt="" class="img-thumbnail rounded-circle">
                            @elseif ($doctors_view->gender == '0') <!-- Assuming '0' for Female -->
                ...
                <div class="col">
                    <div class="p-2">
                        <h3 class="text-white mb-1">{{ $doctors_view->name }}</h3>
                        <p class="text-white text-opacity-75">Reg.ID:- {{ $doctors_view->reg_number ?? 'N/A' }}</p>
                        <div class="hstack text-white-50 gap-1">
                            <div class="me-2"><i class="ri-map-pin-user-line me-1 text-white text-opacity-75 fs-16 align-middle"></i>{{ $doctors_view->address ?? 'N/A' }} </div>
                            {{-- <div><i class="ri-building-line me-1 text-white text-opacity-75 fs-16 align-middle"></i>{{ $doctors_view->clinic->clinic_name ?? 'N/A' }}
                            </div> --}}
                        </div>
                    </div>
                </div>
                ...
                <div>
                    <div class="d-flex profile-wrapper">
                        ...
                        <ul class="nav nav-pills animation-nav profile-nav gap-2 gap-lg-3 flex-grow-1" role="tablist">
                            ...
                            {{-- <li class="nav-item">
                                <a class="nav-link fs-14" data-bs-toggle="tab" href="#clinicname" role="tab">
                                    <i class="ri-price-tag-line d-inline-block d-md-none"></i> <span class="d-none d-md-inline-block">Clinic Name</span>
                                </a>
                            </li> --}}
                            {{-- <li class="nav-item">
                                <a class="nav-link fs-14" data-bs-toggle="tab" href="#bnak" role="tab">
                        ...
                        <div class="flex-shrink-0">
                            <a href="{{ route('edit.doctors',$doctors_view->id) }}" class="btn btn-success"><i class="ri-edit-box-line align-bottom"></i> Edit Profile</a>
                        </div>
                    </div>
                    <!-- Tab panes -->
                                                ...
                                                <table class="table table-borderless mb-0">
                                                    <tbody>
                                                        ...
                                                        <tr>
                                                            ...
                                                            <td class="text-muted">{{ $doctors_view->name }}</td>
                                                        </tr>
                                                        
                                                        <tr>
                                                            <th class="ps-0" scope="row">Mobile :</th>
                                                            <td class="text-muted">{{ $doctors_view->phone }}</td>
                                                        </tr>
                                                        <tr>
                                                        ...
                                                        <tr>
                                                            ...
                                                            <td class="text-muted">
                                                                {{ $doctors_view->gender == 1 ? 'Male' : ($doctors_view->gender == 0 ? 'Female' : 'Not specified') }}
                                                            </td>
                                                            
                                                        </tr>
                                                        <tr>
                                                            <th class="ps-0" scope="row">Location :</th>
                                                            <td class="text-muted">{{ $doctors_view->pathdoctor->locationname }}
                                                            </td>
                                                        </tr>
                                                        <tr>
                                                            <th class="ps-0" scope="row">Joining Date</th>
                                                            <td class="text-muted">{{ $doctors_view->doj }}</td>
                                                        </tr>
                                                        
                                                        <tr>
                                                            <th class="ps-0" scope="row">Date of Birthday</th>
                                                            <td class="text-muted">{{ $doctors_view->dob }}</td>
                                                        </tr>
                                                        <tr>
                                                            <th class="ps-0" scope="row">Aadhar Card Number</th>
                                                            <td class="text-muted">{{ $doctors_view->aadharnumber }}</td>
                                                        </tr>

                                                        <tr>
                                                            <th class="ps-0" scope="row">Specialization :</th>
                                                            <td class="text-muted">{{ $doctors_view->pathdoctor->specialization ?? 'N/A' }}</td>
                                                        </tr>
                                                        <tr>
                                                            <th class="ps-0" scope="row">Registration Number :</th>
                                                            <td class="text-muted">{{ $doctors_view->pathdoctor->registration_number ?? 'N/A' }}</td>
                                                        </tr>
                                                        <tr>
                                                            <th class="ps-0" scope="row">License Number :</th>
                                                            <td class="text-muted">{{ $doctors_view->pathdoctor->license_number ?? 'N/A' }}</td>
                                                        </tr>
                                                        <tr>
                                                            <th class="ps-0" scope="row">Hospital Name :</th>
                                                            <td class="text-muted">{{ $doctors_view->pathdoctor->hospital_name ?? 'N/A' }}</td>
                                                        </tr>
                                                        
                                                        <tr>
                                                            <th class="ps-0" scope="row">Commission :</th>
                                                            <td class="text-muted">{{ $doctors_view->pathdoctor->commission ?? 'N/A' }}%</td>
                                                        </tr>
                                    ...
                                    <div class="card">
                                        <div class="card-body">
                                            ...
                                            <div class="table-responsive">
                                                <table class="table table-borderless mb-0">
                                                    <tbody>
                                                        @if($doctors_view->pathdoctor)
                                                        <tr>
                                                            <th class="ps-0" scope="row">Country:</th>
                                                            <td class="text-muted">{{ $doctors_view->pathdoctor->country->country_name ?? 'N/A' }}</td>
                                                        </tr>
                                                        <tr>
                                                            <th class="ps-0" scope="row">State :</th>
                                                            <td class="text-muted">{{ $doctors_view->pathdoctor->state->state_name }}</td>
                                                        </tr>
                                                        <tr>
                                                            <th class="ps-0" scope="row">City :</th>
                                                            <td class="text-muted">{{ $doctors_view->pathdoctor->city->city_name }}</td>
                                                        </tr>
                                                        <tr>
                                                            <th class="ps-0" scope="row">Location :</th>
                                                            <td class="text-muted">{{ $doctors_view->pathdoctor->locationname }}</td>
                                                        </tr>
                                                        <tr>
                                                            <th class="ps-0" scope="row">Address :</th>
                                                            <td class="text-muted">{{ $doctors_view->address }}</td>
                                                        </tr> 
                                                        @else
                                                            <tr>
