...
return new class extends Migration
{
    ...
    public function up(): void
    {
        Schema::create('staff', function (Blueprint $table) {
            $table->id();
            $table->foreignId('staffuser_id')->references('id')->on('users')->onUpdate('cascade')->onDelete('cascade');
            ...
            $table->foreignId('bankname_id')->references('id')->on('banks')->onUpdate('cascade')->onDelete('cascade');
            $table->foreignId('employeetype_id')->references('id')->on('employee_types')->onUpdate('cascade')->onDelete('cascade');
            $table->foreignId('department_id')->references('id')->on('departments')->onUpdate('cascade')->onDelete('cascade');
            $table->foreignId('designation_id')->references('id')->on('designations')->onUpdate('cascade')->onDelete('cascade');
